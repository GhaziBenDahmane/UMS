                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="panel panel-primary">
                                ...
                                if ($row['filiereID']==8 && $Sub_number!=0) 
                                    echo 'href="matiereSelec.php?type='.$_GET['type'].'&lvlID=28"';
                                elseif ($row['filiereID']==8 && $Sub_number==0) 
                                    echo 'onclick="myFunction()"';
                                elseif ($row['filiereID']==7 && $Sub_number!=0) 
                                    echo 'href="matiereSelec.php?type='.$_GET['type'].'&lvlID=27"';
                                elseif ($row['filiereID']==7 && $Sub_number==0) 
                                    echo 'onclick="myFunction()"';
                                else
                                echo 'href="niveauSelec.php?type='.$_GET['type'].'&filiereID='.$row['filiereID'].'"' ?>>
